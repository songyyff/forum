...
global $fmlist,$gi,$fmastr,$right_saved;
//需要判权
$t=(int)$r->rigt;
$l=(int)$r->level;
if($r->stat=='E'&&($_SESSION['seuserid']?($_SESSION['seright']&$t&$right_saved['userview']&&$l<=$_SESSION['selevel']):($l==1&&$t&$right_saved['guestview']))) {
...
<?php if(isset($_REQUEST['norr']))include "../sub/rag/ser33.php"; ?>
<table width="100%" class="bar2b" border=1 cellpadding=0 cellspacing=0>
<tr height=23>
<TD width="119">&nbsp;精确文字查询</td><td class="pdpage"><?php echo $pagestr; ?>&nbsp;</TD>
<td width="100" align="right"><a href="javascript:submitform()" class="whitelink">[ 提交 ]</a>&nbsp;</td>
