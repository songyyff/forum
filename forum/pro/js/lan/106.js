//	javascript		2012.12
(function(){var F=/(\b(break|delete|if|this|while|case|do|in|throw|with|catch|else|instanceof|try|continue|finally|new|typeof|debugger|for|return|var|default|function|switch|void|true|false|window|document|value|length|focus|innerHTML|alert|confirm|on(click|blur|mouse(over|out))|index(Of)?|lastIndex|char(Code)?At|substr(ing)?|style|(padding|margin|border)(Top|Left|Right|buttom)?|className|name|id|src|href|title|height|width|client(Height|Width))\b)+|\\*['"]|\d+|\/\x2a|\x2a\/|\/\/|\r\n|\r|\n/ig,
W=/\b(break|delete|if|this|while|case|do|in|throw|with|catch|else|instanceof|try|continue|finally|new|typeof|debugger|for|return|var|default|function|switch|void|true|false)\b/i,
rd=/\\*"|\r\n|\r|\n/g,
rs=/\\*'|\r\n|\r|\n/g,
rc=/\x2a\/|\r\n|\r|\n/g,
rr=/\r\n|\r|\n/g;
