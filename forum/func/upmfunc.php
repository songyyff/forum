...
if($_S[seuserpass]&&$_S[seuserpass]!=$_R[acouserpass]){$_S=array();session_destroy();f_toerror("illegallogin");}
...
}else if(!$_S['selgd']){$_S=array();$_S['seuserid']=0;$_S['selgd']=1;$_S['seitsize']=$v_defitsize;$_S['serpsize']=$v_defrpsize;$_S["senew"]=24;$_S["sestyle"]="blue1";$_S[seismng]=0;if(isset($_COOKIE["cousername"])){include "../func/login.php";f_login(urldecode($_COOKIE["cousername"]),$_COOKIE["couserpass"],1);}}
